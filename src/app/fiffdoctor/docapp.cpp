...
DocApp::DocApp()
{
    _commandFnMap = {
        ...
        {"show", &DocApp::show},
        {"edit", &DocApp::edit},
        {"create", &DocApp::create},
        {"copy", &DocApp::copy},
        {"remove", &DocApp::remove},
        {"close", &DocApp::close},
        {"exit", &DocApp::exit},
        };
}
...
void DocApp::edit(const std::string& command)
{
    (void)command;
}

void DocApp::create(const std::string& command)
{
    (void)command;

}

void DocApp::copy(const std::string& command)
{
    (void)command;

}

void DocApp::remove(const std::string& command)
{
    (void)command;

}

void DocApp::close(const std::string& command)
{
    (void)command;
